...
# when you create a class, __init__ runs it automatically
...
class NigerianStudent:
    def __init__(self, name, state, course):
        ...
        print(f"Step 6: {self.name} from {self.state} is ready!")
...
class Student:
    ...
    #1. instance methods - unique to or works with a specific student
    def pay_school_fees(self):
...
print(Abiodun.academic_calendar())

# Attributes store the data while methods use and modify the data
class BankAccount:
    ...
    def transfer(self, amount, reciepient):
        """Transfer money to another account"""
        if amount > 0 and amount <= self.balance:
            self.balance -= amount
            return f"₦{amount:,} transferred from {self.owner} to {reciepient}. Remaining balance: ₦{self.balance:,}"
...
Phone_1 = NaijaPhone("Techno", "S10", "MTN")

print(Phone_1.power_on())
print(Phone_1.buy_airtime(500))
print(Phone_1.make_call("09099090909"))
print(Phone_1.send_sms("I want to Fly", "08172600297"))
...
BRT_7699 = BRTBus("Ikorodu-Obalende", "AGG-7890")

print(BRT_7699.announce_stop())
print(BRT_7699.board_passengers(10))